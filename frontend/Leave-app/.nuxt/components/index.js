...
export const MenuPagesCreate = () => import('../..\\components\\MenuPages\\createAdmin\\create.vue' /* webpackChunkName: "components/menu-pages-create" */).then(c => wrapFunctional(c.default || c))
